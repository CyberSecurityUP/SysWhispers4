/*
 * SW4_msvcSyscalls_Types.h -- generated by SysWhispers4
 ...
 */
#pragma once
#ifndef SW4_msvc_SYSCALLS_TYPES_H
#define SW4_msvc_SYSCALLS_TYPES_H
...
typedef struct _SW4_msvc_SSN_ENTRY {
    DWORD  Count;
    struct {
        DWORD Build;
        DWORD Ssn;
...
typedef struct _SW4_msvc_EXPORT {
    PVOID Address;
    DWORD Hash;
    DWORD Ordinal;
} SW4_msvc_EXPORT, *PSW4_msvc_EXPORT;

#endif /* SW4_msvc_SYSCALLS_TYPES_H */
